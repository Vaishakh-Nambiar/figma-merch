...
function Nav() {
  return (
    <nav className="flex justify-between items-center w-full p-6 font-au  text-black ">
      <div className=" flex ">
        <Link to="/" className="text-black  md:block ">
          <Buttons value="Shop" className="" />
        </Link>
        <Link to="/about" className="text-black  md:block">
          <Buttons value="About" />
        </Link>
      </div>
      ...
      <div className="hidden md:block">
        <div className="flex">
          <Link to="/cart" className="text-black hidden md:block">
            <Buttons value="Cart" />
          </Link>
